...
public class S05Ejercicio44 {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.printf("Introduce la posición donde quieres insertar el dígito (min=2. max=%d): %n", longitud);
        ...
        int cantidadCeros = (int) Math.pow(10, longitud - posicion + 1);

        numeroIzquierda = numero / cantidadCeros;
        numeroIzquierda = (numeroIzquierda * 10 + digito) * cantidadCeros;
